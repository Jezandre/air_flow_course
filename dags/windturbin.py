...
group_database = TaskGroup("group_databse", dag=dag)
...
chack_temp_branch = BranchPythonOperator(
...
with group_check_temp:
    chack_temp_branch >> [send_email_alert, send_email_normal]
